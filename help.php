...
<html>
<head>
<title>Horux-Mailer</title>
<style type="text/css">
body { background-color:#000000; font-weight:bold; font-family:Arial; font-size:120%;}
.mainbox { background-color:#3F3F3F; padding:6px; margin:0px;border: 1px solid #E1807C;text-align:center; }
.txtbox { vertical-align:top;background-color:#222222; padding:6px; margin:0px;border: 0px solid #E1807C;text-align:center; }
.title {font:italic bold 16px Helvetica;background-color:#222222; padding:6px; margin:0px;border: 0px solid #E1807C;text-align:center;}
.txt {font:italic bold 12px Helvetica;color:#E1807C}
.sm {font:italic bold 10px Helvetica;text-align:left;}
.button {background-color : #3F3F3F;color : #000000;font-size: 11px; font-family: Verdana, Arial, Helvetica, sans-serif;border: 1px solid #ffffff}
</style>
...
<center> <table align="center" class="mainbox" width="70%"><tr><td valign="top">
	...
	<div class="title"><font color="#F5F5F5">Horux-Mailer V.2.2 Horux.ru</font></div>
	<center><img src='http://s13.postimg.org/7gjn32xt3/IMG2.png'></center>
<font class="txt">
<?php
...
<center><font color="white" size="-2">Horux-Mailer V.2.2 by Horux.ru</font></center>
</body>
</html>
<?php
	}
...
<p align="left">
<a href="javascript:expand()"><h2><font color="#FFA6A6">READ HOW TO USE !</font></h2></a></p><div id="About" style="display:none">
<p align="left">
...
<center><font color="white" size="-2">Horux-Mailer V.2.2 powered by Horux.ru </font></center>
</body>
</html>
<?php
}
